...
/*   Updated: 2019/01/18 15:36:31 by gpouyat          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return ((right_rot32(x, 28) ^ right_rot32(x, 34) ^ right_rot32(x, 39)));
}

uint64_t	sha512_bsig1(uint64_t x)
{
	return (right_rot32(x, 14) ^ right_rot32(x, 18) ^ right_rot32(x, 41));
}
