...
/*   Updated: 2019/01/04 16:09:13 by gpouyat          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void			md5_operations_end_loop(t_md5_operaions_value *val,
...
static void			md5_operations_loop(t_md5_operaions_value *val,
															unsigned char i)
{
	uint32_t	f;
	uint32_t	g;
